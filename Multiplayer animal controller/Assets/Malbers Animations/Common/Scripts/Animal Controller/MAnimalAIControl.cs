    ...
    public class MAnimalAIControl : MonoBehaviour, IAIControl, IAITarget,  IAnimatorListener
    {
        ...
        public float SlowMultiplier
        {
            get
            {
                ...
                {
                    result = RemainingDistance / slowingDistance;
                    if (result < slowingLimit) result = slowingLimit;
                }
                return result;
            }
        }
        ...
        protected float DefaultSlowingDistance;
        ...
        [SerializeField] [UnityEngine.Serialization.FormerlySerializedAs("walkDistance")]
        protected float slowingDistance = 1f;

        [Tooltip("Limit for the Slowing Multiplier")]
        [SerializeField] private float slowingLimit = 0.3f;

        internal void ResetStoppingDistance() { StoppingDistance = DefaultStopDistance; }
        internal void ResetSlowingDistance() { slowingDistance = DefaultSlowingDistance; }
        ...
        /// <summary>Current Slowing Distance for the Next Waypoint</summary>
        public virtual float SlowingDistance
        {
            get => stoppingDistance;
        ...
        #endregion 
        public virtual void SetActive(bool value) => gameObject.SetActive(enabled = value);
        ...
        private void Awake()
        {
            ...
            DefaultSlowingDistance = SlowingDistance;                             //Store the Started Stopping Distance
        ...
        public virtual void UpdateAgent()
        {
            ...
            else
            {
                ...
                animal.Move(Agent.desiredVelocity.normalized * SlowMultiplier);                     //Move the Animal using the Agent Direction
                CheckOffMeshLinks();
            }
        }
        ...
        public virtual void SetTarget(Transform target, bool Move)
        {
            ...
            if (this.target != null)
            {
                ...
                SlowingDistance = GetTargetSlowingDistance();
        ...
        public virtual float GetTargetSlowingDistance() => IsAITarget != null ? IsAITarget.SlowDistance() : DefaultSlowingDistance;
        ...
        protected virtual void FreeMovement()
        {
            ...
            animal.Move((DestinationPosition - animal.transform.position).normalized * SlowMultiplier); //Important to be normalized!!
       ...
       //private bool wasMovingBeforeMode;
        ...
        public float SlowDistance() => DefaultSlowingDistance;
        ...
        protected virtual void CheckSlowDistance()
        {
            if (SlowingDistance > 0)
            {
                if (SlowingDistance > RemainingDistance)
                {
        ...
        protected virtual void OnDrawGizmos()
        {
            ...
            UnityEditor.Handles.DrawWireDisc(Pos, Vector3.up, slowingDistance);
