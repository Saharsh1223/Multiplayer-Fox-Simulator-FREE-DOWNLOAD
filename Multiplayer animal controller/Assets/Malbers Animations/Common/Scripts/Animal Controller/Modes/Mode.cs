...
namespace MalbersAnimations.Controller
{
    ...
    public class Mode
    {
        ...
        [Tooltip("Audio Source assigned to the Mode")]
        ...
        public virtual void ResetMode()
        {
            ...
            ActiveAbility.Properties.modifier?.OnModeExit(this);
        ...
        private void Activate(Ability newAbility, int modeStatus, string deb)
        {
            ...
            ActiveAbility.Properties.modifier?.OnModeEnter(this); //Active Local Mode Modifier

            if (m_Source != null &&  ActiveAbility.Properties.clip != null)
            {
                m_Source.clip = ActiveAbility.Properties.clip;
                m_Source.Play();
            }
        ...
        public virtual void OnModeStateMove(AnimatorStateInfo stateInfo, Animator anim, int Layer)
        {
            ...
            if (Animal.ActiveMode == this)
            {
                ...
                ActiveAbility.Properties.modifier?.OnModeMove(this, stateInfo, anim, Layer);
            }
        }
