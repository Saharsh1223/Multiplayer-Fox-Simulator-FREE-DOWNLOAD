...
namespace MalbersAnimations.Controller
{
    ...
    public class MWayPoint : MonoBehaviour, IWayPoint
    {
        ...
        void OnDrawGizmos()
        {
            ...
            else
            {
                ...
                Gizmos.color = Color.cyan;
                UnityEditor.Handles.DrawWireDisc(base.transform.position, transform.up, slowingDistance);
            }
    ...
    public class MWayPointEditor : UnityEditor.Editor
    {
        UnityEditor.SerializedProperty
            pointType, stoppingDistance, slowingDistance, WaitTime, nextWayPoints, DebugColor, OnTargetArrived;
