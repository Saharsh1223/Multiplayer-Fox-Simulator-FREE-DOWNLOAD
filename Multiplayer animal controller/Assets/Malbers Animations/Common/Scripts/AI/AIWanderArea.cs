...
namespace MalbersAnimations
{
    ...
    public class AIWanderArea : MonoBehaviour, IWayPoint
    {
        ...
        public float SlowDistance() => MainArea.slowingDistance;
    ...
    public class AIWanderAreaEditor : UnityEditor.Editor
    {
        UnityEditor.SerializedProperty
            pointType, stoppingDistance, slowingDistance, m_AreaType, radius, BoxArea, WaitTime, WanderWeight, nextWayPoints, DebugColor, OnTargetArrived;
        AIWanderArea M;
