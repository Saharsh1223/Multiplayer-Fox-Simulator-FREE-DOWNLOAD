...
namespace MalbersAnimations
{
    ...
    public class MInput : MonoBehaviour, IInputSource
    {
        ...
        [ContextMenu("Create/SpeedUP")]
        private void CreateSpeedUP()
        {
            inputs.Add(new InputRow(true, "Speed Up", "Speed Up", KeyCode.Alpha2, InputButton.Down, InputType.Key));
            MTools.SetDirty(this);
        }


        [ContextMenu("Create/SpeedDown")]
        private void CreateSpeedDown()
        {
            inputs.Add(new InputRow(true, "Speed Down", "Speed Down", KeyCode.Alpha1, InputButton.Down, InputType.Key));
            MTools.SetDirty(this);
        }
    }
