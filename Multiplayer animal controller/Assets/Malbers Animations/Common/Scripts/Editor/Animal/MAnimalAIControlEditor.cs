...
namespace MalbersAnimations.Controller
{
    ...
    public class AnimalAIControlEd : Editor
    {
       ...
       // MonoScript script;
        ...
        SerializedProperty stoppingDistance, SlowingDistance, targett, AutoNextTarget, slowingLimit, agent, animal, PointStoppingDistance,
        ...
        private void ShowGeneral()
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            {
                EditorGUI.BeginChangeCheck();
                {
                    ...
                    EditorGUILayout.PropertyField(SlowingDistance, new GUIContent("Slowing Distance", "Distance to Start Slowing the animal"));
                    ...
                    if (SlowingDistance.floatValue <= 0)
                    {
