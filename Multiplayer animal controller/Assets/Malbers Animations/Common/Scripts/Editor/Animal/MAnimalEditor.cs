      ...
      //  private ReorderableList Reo_List_Pivots;
        ...
        SerializedProperty
            ...
            AlignRotLerp, m_gravity, m_gravityPower, useCameraUp, ground_Changes_Gravity,
             useSprintGlobal,  SmoothVertical, TurnMultiplier,  Player, OverrideStartState, CloneStates, S_Speed_List, UseCameraInput,
        ...
        //EditorStuff
        SerializedProperty 
            ShowMovement, ShowStateInInspector, ShowFreeMovement, BankLerp, PitchLerpOff, PitchLerpOn,
       ...
       // private MonoScript script;
        ...
        private void FindSerializedProperties()
        {
            ...
            BankLerp = serializedObject.FindProperty("BankLerp");
            ...
            ShowFreeMovement = serializedObject.FindProperty("ShowFreeMovement");
           ...
           // ShowpivotColor = serializedObject.FindProperty("ShowpivotColor");
            ...
            PitchLerpOn = serializedObject.FindProperty("PitchLerpOn");
            PitchLerpOff = serializedObject.FindProperty("PitchLerpOff");
